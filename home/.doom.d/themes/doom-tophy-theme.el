;; doom-tophy-theme.el --- My custom theme -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup doom-tophy-theme nil
  "Options for the `doom-tophy' theme."
  :group 'doom-themes)

(defcustom doom-tophy-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-tophy-theme
  :type '(choice integer boolean))

(def-doom-theme doom-tophy
  "My custom theme based on Monokai Pro"
  ...
  ((bg         '("#181818" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-tophy-padded-modeline
      (if (integerp doom-tophy-padded-modeline)
          doom-tophy-padded-modeline
        4))))
...
(provide 'doom-tophy-theme)
;;; doom-tophy-theme.el ends here
